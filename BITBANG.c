...
void main(void)
{
    ...
    BCSCTL3 |= LFXT1S_2 + DIVA_0;              // ACLK = VLO
...
// filled rectangle
void fillrect(unsigned char *buff, unsigned char x, unsigned char y,
...
// draw a rectangle
void drawrect(unsigned char *buff, unsigned char x, unsigned char y,
              unsigned char w, unsigned char h)
{
    unsigned char i;
    // stupidest version - just pixels - but fast with internal buffer!
